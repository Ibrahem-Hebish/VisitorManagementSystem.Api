    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PermitId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    HandledBy = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    VisitorId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Permit_Visitor_VisitorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedBy = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BranchId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    VisitorId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "PermitId");
                    table.ForeignKey(
                        name: "FK_Belonging_Visitor_VisitorId",
                        column: x => x.VisitorId,
                        principalTable: "Visitor",
                        principalColumn: "VisitorId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermitUpdateRequest_PermitId",
                table: "PermitUpdateRequest",
                column: "PermitId");
