...
public class UserToken : Entity
{
    ...
    {
        Raise(new NewTokenCreated(Id.Id, AccessToken, RefreshToken, AccessTokenExpiredDate, RefreshTokenExpiredDate, branchId));
    }

    public void RaiseTokenUpdatedEvent(string? branchId)
    {
        Raise(new NewTokenUpdated(Id.Id, AccessToken, RefreshToken, AccessTokenExpiredDate, RefreshTokenExpiredDate, branchId));
    }
}
